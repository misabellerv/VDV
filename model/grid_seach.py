...
class GSCVTrainer:
    ...
    def fit(self, X_train, y_train):
        ...
        best_model_path = results_path + '/best_model.pkl'
        joblib.dump(self.grid_search.best_estimator_, best_model_path)
    ...
    def predict(self, X_test, y_test):
        ...
        if self.grid_search is None:
            raise ValueError("The model has not been trained yet. Call `fit` or `grid_search_fit` method before `predict`.")
